...
*****************
This fork adds support for Printrboard/Teensylu/AT90USBxx chips with native USB
Also Sanguinololu and compatibles, such as Panucatt Azteeg X1

Arduino: make -f Makefile.Arduino
Printrboard: make -f Makefile.Printrboard
Sanguinololu: make -f Makefile.Sanguinololu

20121108 SCL
- add Sanguinololu/X1 support

20120309 SCL
- added Printrboard support
*****************
